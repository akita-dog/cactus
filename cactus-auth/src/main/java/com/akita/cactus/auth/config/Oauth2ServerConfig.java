...
public class Oauth2ServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public KeyPair keyPair() {
        KeyStoreKeyFactory keyStoreKeyFactory = new KeyStoreKeyFactory(new ClassPathResource("jwt.jks"), "cactus-jwt".toCharArray());
        return keyStoreKeyFactory.getKeyPair("jwt", "cactus-jwt".toCharArray());
    }
}
